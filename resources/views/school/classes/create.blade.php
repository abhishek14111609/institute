                ...
                <form action="{{ route('school.classes.store') }}" method="POST">
                                ...
                                @forelse($subjectTemplates as $template)
                                    <div class="form-check subject-template-option"
                                        ...
                                        <input class="form-check-input" type="checkbox" name="subject_template_ids[]"
                                            ...
                                            {{ in_array($template->id, old('subject_template_ids', [])) ? 'checked' : '' }}>
                    ...
                    <div class="col-md-12">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name"
                                ...
                                placeholder="{{ auth()->user()->school->institute_type === 'sport' ? 'e.g. U-16 Boys' : 'e.g. Grade 10' }}"
                                required>
                            @error('name')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            ...
                            {{ auth()->user()->school->institute_type === 'sport' ? 'Create Team' : 'Create Class' }}
                        </button>
