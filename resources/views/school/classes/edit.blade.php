...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2>{{ auth()->user()->school->institute_type === 'sport' ? 'Edit Team: ' : 'Edit Class: ' }} {{ $class->name }}</h2>
            ...
            <form action="{{ route('school.classes.update', $class) }}" method="POST">
                ...
                <div class="d-flex gap-2">
                    <button type="submit" class="btn btn-primary">
                        <i class="bi bi-check-circle"></i> {{ auth()->user()->school->institute_type === 'sport' ? 'Update Team' : 'Update Class' }}
                    </button>
