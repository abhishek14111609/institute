                ...
                <form action="{{ route('school.students.update', $student) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control @error('phone') is-invalid @enderror"
                                    ...
                                    data-user-id="{{ $student->user_id }}" placeholder="e.g. 9876543210 (10 digits)">
                                @error('phone')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('username') is-invalid @enderror"
                                    ...
                                    data-rules="required|alpha_dash|min:3" data-user-id="{{ $student->user_id }}">
                                @error('username')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control bg-light" id="roll_number" name="roll_number"
                        ...
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control @error('parent_phone') is-invalid @enderror"
                                    ...
                                    value="{{ old('parent_phone', $student->parent_phone) }}" data-ajax-validate="true"
                                    data-table="students" data-rules="nullable|numeric|min:10|max:10"
                        ...
                        @if ($student->photo)
                            <div class="mb-2">
                                <img src="{{ route('media.public', ['path' => $student->photo]) }}"
                                    alt="{{ $student->user->name }}" width="100" class="rounded">
                            </div>
                        @endif
                    ...
                    <div class="mb-3">
                        <div class="form-check">
                            ...
                            <input class="form-check-input" type="checkbox" id="is_active" name="is_active"
                                value="1" {{ old('is_active', $student->user->is_active) ? 'checked' : '' }}>
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary px-4 rounded-pill">
                            <i class="bi bi-check-circle-fill me-2"></i> Update Student Profile
                        </button>
                        <a href="{{ route('school.students.index') }}"
                            class="btn btn-light px-4 rounded-pill border">Cancel</a>
                    </div>
                </form>
            </div>
        </div>
        ...
        <script>
            ...
            function populateBatches(rowId, courseId, preSelectedBatchId = null) {
                ...
                filteredBatches.forEach(b => {
                    ...
                    batchSelect.innerHTML +=
                        `<option value="${b.id}" ${b.id == preSelectedBatchId ? 'selected' : ''}>${b.name}${className}${courseName}</option>`;
                });
            ...
            function populateFees(rowId, batchId) {
                ...
                if (relevantPlans.length === 0) {
                    feeContainer.innerHTML =
                        '<small class="text-muted small w-100 text-center py-1">No additional fee plans available.</small>';
                    return;
                }
            ...
            function removeRow(rowId) {
                const container = document.getElementById('enrollment_rows_container');
                if (container.children.length > 1 || confirm('Remove this student from this batch?')) {
                    const row = document.getElementById(rowId);
