                ...
                <form action="{{ route('school.teachers.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="tel" class="form-control @error('phone') is-invalid @enderror"
                                    id="phone" name="phone" value="{{ old('phone') }}" data-ajax-validate="true"
                                    data-table="users" data-rules="nullable|digits:10"
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label for="employee_id"
                                    class="form-label">{{ auth()->user()->school->institute_type === 'sport' ? 'Staff/Coach ID' : 'Employee ID' }}
                                    (Auto-generated)</label>
                                <input type="text" class="form-control bg-light" id="employee_id" name="employee_id"
                                    value="{{ old('employee_id') }}" readonly placeholder="Auto-generated">
                                @error('employee_id')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            ...
                            {{ auth()->user()->school->institute_type === 'sport' ? 'Create Coach' : 'Create Teacher' }}
                        </button>
