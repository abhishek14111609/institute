            ...
            <form action="{{ route('school.subjects.update', $subject) }}" method="POST">
                ...
                <div class="row">
                    ...
                    @else
                        ...
                        <div class="col-md-4 mb-3">
                            <label for="class_id" class="form-label fw-semibold">Class / Grade <span class="text-danger">*</span></label>
                            <select class="form-select @error('class_id') is-invalid @enderror"
                                ...
                                @foreach($classes as $class)
                                    <option value="{{ $class->id }}" data-course="{{ $class->course_id }}"
                                        ...
                                        @if(old('course_id', $subject->schoolClass->course_id ?? '') && old('course_id', $subject->schoolClass->course_id ?? '') != $class->course_id) style="display:none" @endif>
                                        {{ $class->name }}
                                    </option>
                                @endforeach
                            </select>
